...
/*
	...
	Este fichero parte ha sido modificado para que no genere ficheros de salida, de log, ni
	de error
...
*/
    ...
    if ( !ip->path[2] || !ip->path[2][0] ) {
        ...
        *log_file = stderr; //log file direccionado al error estandar
    } else
	   *log_file = stderr; //log file direccionado al error estandar
    ...
    if ( !ip->path[1] || !ip->path[1][0] ) {
        ...
        *output_file = stdout; //salida ppal direccionada a salida estandar
    } else {
		*output_file = stdout; //salida ppal direccionada a salida estandar
		/*
...
#endif
		*prb_file = stderr;
		/*fichero de error ignorado completamente*/
		/*
